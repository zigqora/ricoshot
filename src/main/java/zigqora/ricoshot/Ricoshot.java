...
public class Ricoshot implements ModInitializer {
	...
	public static final EntityType<FlyingNuggetEntity> FLYING_NUGGET_ENTITY_TYPE = Registry.register(
			...
			FabricEntityTypeBuilder.<FlyingNuggetEntity>create(MobCategory.MISC, FlyingNuggetEntity::new)
					.dimensions(EntityDimensions.fixed(0.25f, 0.25f))
					.trackRangeChunks(4).trackedUpdateRate(10).build(FLYING_NUGGET_KEY));
